...
public class Web2EnterpriseApp {
    public static void main(String[] args) {
        System.out.println("Welcome to the Web 2.0 Era!");
        System.out.println("Java continues to power enterprise solutions with rich interactive experiences.");
    }
}
